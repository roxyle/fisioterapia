...
import { Terapie } from '@/constants/data'
...
export default function CardTerapie (dettagliTerapia: MyProps) {
  ...
  return (
    <div className='relative flex flex-row justify-center items-center p-10'>
          <div className={`cursor-pointer card ${isFlipped? "flipped" : ""}`}>
            ...
            <div className='bg-white text-black card-face card-back flex flex-col gap-2
              ...
              onClick={handleImageChange}>
                  ...
                  <h2 className='underline py-10'>{dettagliTerapia.text}:</h2>
