...
export default function CardServizi (dettagliServizi: MyProps) {
  ...
  return (
    <div className='relative flex flex-row justify-center items-center p-3'>
          <div className={`cursor-pointer card-serv ${isFlipped? "flipped" : ""}`}>
            <div className='bg-white card-face' onClick={handleImageChange} >  
                ...
                <Image className='object-cover' 
                  ...
                  <div className='text-black flex flex-col items-center py-5 flex-wrap'>
                    <h2 className=' font-bold underline'>{dettagliServizi.titolo}</h2>     
            ...
            <div className='bg-white text-black card-face card-back flex flex-col gap-2 
              items-center justify-start'
              onClick={handleImageChange}>  

                  <div className='flex flex-col items-center justify-center py-5'> 
                    <h2 className='underline py-3 font-bold'>{dettagliServizi.titolo}:</h2>                                                      
