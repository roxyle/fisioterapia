...
export default function ContCardServizi (props: Props) {
  return (
        ...
        <div className='flex flex-col items-center bg-gradient-to-t from-white to-90% rounded-xl p-5'>
          <h2 className='font-bold underline text-white text-4xl rounded-t-xl title'>Alcuni Dei Nostri Servizi </h2>
